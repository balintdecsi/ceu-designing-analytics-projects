# Cursor CLI Agent Project Context

## Overview
This file serves as a persistent context and guide for Cursor CLI agents working on this project. It captures key project details, recurring issues, and established best practices to ensure consistency and prevent repeated errors.
...
**AI Declaration:** I've used AI for this task according to our MS program's [AI policy](https://gabors-data-analysis.com/aipolicy/). This document's structural skeleton (headings etc.) and typesetting were assisted by the Cursor CLI tool, using Cursor 3. The prompt used was: "Make a skeleton for the report based on Week 3 task in the task description. Stick to the outline of the task markdown file."
```
